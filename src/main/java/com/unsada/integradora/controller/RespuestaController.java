...
public class RespuestaController {
	...
	public Map<String, Object> listclase() {
		...
		try {
			List<Respuesta> claseData;
			claseData = (List<Respuesta>) respuestaServiceApi.findAll();
	...
	public Map<String, Object> dataClase(@PathVariable("id") Integer id) {
		...
		try {
			...
			Optional<Respuesta> clase = respuestaServiceApi.findById(id);
	...
	public ResponseEntity<String> create(@RequestBody Respuesta data) {
	...
	public Map<String, Object> update(@PathVariable("id") Integer id) {
		...
		try {
			respuestaServiceApi.deleteById(id);
